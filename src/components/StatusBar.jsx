    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          width: `${(pct / 100) * 16}px`,
          background: pct > 20 ? 'white' : '#ff3b30',
        }} />
      </div>
    </div>
  )
...
function WifiIcon() {
  return (
    <svg width="14" height="11" viewBox="0 0 14 11" fill="white">
      ...
      <path opacity=".5" d="M3.8 6.2a4.5 4.5 0 0 1 6.4 0l-1 1a3 3 0 0 0-4.4 0l-1-1z" />
      <path opacity=".25" d="M1.1 3.5a8 8 0 0 1 11.8 0l-1 1a6.5 6.5 0 0 0-9.8 0l-1-1z" />
    </svg>
  )
}
